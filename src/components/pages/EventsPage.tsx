...
export default function EventsPage() {
  ...
  // Get the next featured event for countdown
  ...
  const totalEmployers = [...new Set(events.flatMap(e => e.employers || []))].length;
    ...
    <div style={styles.container}>
      ...
      <header style={{
        ...
        <div style={{
          ...
          Discover {totalEvents}+ Events Across {industries.length - 1} Industries
        </div>
        ...
        <h1 style={{
          ...
          marginBottom: 16,
          lineHeight: 1.1,
          background: 'linear-gradient(135deg, #fff 0%, #93c5fd 50%, #bfdbfe 100%)',
        ...
        <p style={{
          ...
          The premier destination for workforce development events — bringing together
          <span style={{ color: '#3b82f6' }}> job seekers</span>,
          <span style={{ color: '#10b981' }}> industry leaders</span>,
          <span style={{ color: '#8b5cf6' }}> educators</span>, and
          <span style={{ color: '#64748b' }}> government partners</span> to
          build the STEM talent pipeline of tomorrow
        </p>
        ...
        <div style={{
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#64748b', marginTop: 4 }}>Participants</div>
          </div>
          ...
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#64748b', marginTop: 4 }}>Industry Partners</div>
          </div>
          <div style={{ width: 1, background: 'rgba(255,255,255,0.1)', alignSelf: 'stretch' }} />
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#64748b', marginTop: 4 }}>Education Providers</div>
          </div>
          <div style={{ width: 1, background: 'rgba(255,255,255,0.1)', alignSelf: 'stretch' }} />
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#64748b', marginTop: 4 }}>Gov Agencies</div>
          </div>
          <div style={{ width: 1, background: 'rgba(255,255,255,0.1)', alignSelf: 'stretch' }} />
          <div style={{ textAlign: 'center' }}>
            ...
            <div style={{ fontSize: 12, color: '#64748b', marginTop: 4 }}>Event Types</div>
          </div>
        </div>

        {/* Featured Event Countdown Card */}
        {nextFeaturedEvent && (
          <div style={{
            maxWidth: 700,
            margin: '0 auto 40px',
            ...
            <div style={{ flex: 1, minWidth: 280 }}>
              ...
              <p style={{ fontSize: 14, color: '#94a3b8', marginBottom: 12 }}>
                {nextFeaturedEvent.subtitle}
              </p>
              <div style={{ display: 'flex', gap: 16, fontSize: 13, color: '#64748b' }}>
                <span>📅 {formatDate(nextFeaturedEvent.date, nextFeaturedEvent.endDate)}</span>
            ...
            <div style={{
              ...
              {(() => {
                const countdown = getCountdown(nextFeaturedEvent.date);
                return (
                  <>
                    <div style={{
                      textAlign: 'center',
                      ...
                      <div style={{ fontSize: 11, color: '#64748b', textTransform: 'uppercase' }}>Days</div>
                    </div>
                    <div style={{
                      textAlign: 'center',
                      padding: '16px 20px',
                      ...
                      <div style={{ fontSize: 11, color: '#64748b', textTransform: 'uppercase' }}>Hours</div>
                    </div>
                  </>
                );
              })()}
              <button
                onClick={() => setSelectedEvent(nextFeaturedEvent)}
                style={{
                  padding: '14px 24px',
                  background: 'linear-gradient(135deg, #3b82f6, #2563eb)',
                  border: 'none',
        ...
        {/* User Type Selection - Enhanced for All Stakeholders */}
        <div style={{ marginTop: 16 }}>
          <p style={{
            fontSize: 15,
            color: userType ? '#10b981' : '#94a3b8',
            marginBottom: 16,
            fontWeight: 500,
          }}>
            {userType
              ? `✓ Showing events for ${audienceTypes.find(a => a.id === userType)?.name}`
              : 'Find events tailored to your role...'}
          </p>
          <div style={{
            display: 'flex',
            gap: 10,
            ...
            {audienceTypes.map(audience => (
              <button
                ...
                style={{
                  padding: '10px 18px',
                  background: userType === audience.id
                    ? `linear-gradient(135deg, ${audience.color}40, ${audience.color}20)`
                    : 'rgba(255,255,255,0.05)',
                  border: userType === audience.id
                    ? `2px solid ${audience.color}`
                    : '1px solid rgba(255,255,255,0.15)',
                  borderRadius: 10,
                  color: userType === audience.id ? '#fff' : '#94a3b8',
                  cursor: 'pointer',
                  fontSize: 13,
                  fontWeight: userType === audience.id ? 600 : 400,
                  display: 'flex',
                  alignItems: 'center',
                  gap: 8,
                  transition: 'all 0.25s ease',
                  transform: userType === audience.id ? 'scale(1.02)' : 'scale(1)',
                }}
                onMouseOver={(e) => {
                  if (userType !== audience.id) {
                    e.currentTarget.style.background = `${audience.color}15`;
                    e.currentTarget.style.borderColor = `${audience.color}60`;
              ...
              >
                <span style={{ fontSize: 16 }}>{audience.icon}</span>
                {audience.name}
                {userType === audience.id && <span style={{ marginLeft: 4 }}>✓</span>}
              </button>
            ))}
          </div>
          {userType && (
