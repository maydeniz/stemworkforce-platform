...
const partnerTypes = {
  ...
  healthcare: {
    ...
    citizenshipOptions: ['Work Authorized', 'Visa Sponsorship Available', 'Open to All'],
    specialRequirements: ['HIPAA Compliance', 'OSHA Healthcare', 'State Licensure', 'Clinical Credentialing', 'Drug Screening'],
    valueProps: [
