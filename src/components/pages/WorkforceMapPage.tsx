...
const stateDetails: Record<string, {
  ...
  MA: {
    ...
    technicians: 42000,
    engineers: 31000,
    hubs: ['Boston', 'Cambridge', 'Worcester'],
    salaries: { engineer: '$142K', technician: '$72K', operator: '$58K' },
    skills: ['Health Informatics', 'Medical Devices', 'Clinical Research', 'Healthcare AI', 'HIPAA Compliance'],
    employers: [
      { name: 'Mass General Brigham', positions: 18500, growth: '+12%' },
      { name: 'Boston Scientific', positions: 8200, growth: '+15%' },
      { name: 'Philips Healthcare', positions: 5600, growth: '+8%' },
      { name: 'Epic Systems (Regional)', positions: 2800, growth: '+22%' }
    ],
    training: [
      { name: 'MIT Health Sciences & Tech', type: 'University', duration: '4 years', cost: '$58,000', placement: 98 },
      { name: 'Harvard Medical School Informatics', type: 'University', duration: '2 years', cost: '$62,000', placement: 97 },
      { name: 'Bunker Hill CC Health IT', type: 'Community College', duration: '2 years', cost: '$8,500', placement: 89 }
    ],
    pathways: [
      { level: 'Entry Level', roles: [
        { title: 'Health Information Tech', salary: '$45K-$58K', requirement: 'HS + Certification' },
        { title: 'Medical Coder', salary: '$42K-$55K', requirement: 'Certification (CPC/CCS)' },
        { title: 'Clinical Data Entry', salary: '$38K-$48K', requirement: 'HS Diploma' }
      ]},
      { level: 'Technician', roles: [
        { title: 'Health IT Specialist', salary: '$62K-$78K', requirement: 'Associate + HIPAA Cert' },
        { title: 'Medical Device Tech', salary: '$58K-$72K', requirement: 'Associate Degree' },
        { title: 'Clinical Research Coordinator', salary: '$55K-$70K', requirement: "Bachelor's" }
      ]},
      { level: 'Analyst/Specialist', roles: [
        { title: 'Health Data Analyst', salary: '$75K-$95K', requirement: "Bachelor's + Analytics" },
        { title: 'EHR Implementation Specialist', salary: '$80K-$105K', requirement: 'Epic/Cerner Cert' },
        { title: 'Clinical Informatics Specialist', salary: '$85K-$110K', requirement: "Bachelor's + RN/Clinical" }
      ]},
      { level: 'Engineer/Leadership', roles: [
        { title: 'Healthcare Software Engineer', salary: '$125K-$165K', requirement: "Bachelor's CS + Healthcare" },
        { title: 'Biomedical Engineer', salary: '$130K-$170K', requirement: "Master's BME" },
        { title: 'Chief Health Informatics Officer', salary: '$180K-$250K', requirement: "Master's + 10yr exp" }
      ]}
    ]
  },
  MN: {
    ...
    technicians: 32000,
    engineers: 24000,
    hubs: ['Minneapolis', 'Rochester', 'St. Paul'],
    salaries: { engineer: '$128K', technician: '$68K', operator: '$54K' },
    skills: ['Medical Devices', 'Health Insurance Tech', 'Clinical Trials', 'Population Health', 'Telemedicine'],
    employers: [
      { name: 'Mayo Clinic', positions: 15200, growth: '+10%' },
      { name: 'UnitedHealth Group', positions: 22000, growth: '+18%' },
      { name: 'Medtronic', positions: 12500, growth: '+8%' },
      { name: 'Optum', positions: 8900, growth: '+25%' }
    ],
    training: [
      { name: 'U of Minnesota Health Informatics', type: 'University', duration: '4 years', cost: '$38,000', placement: 95 },
      { name: 'Mayo Clinic School of Health Sciences', type: 'Medical School', duration: '2-4 years', cost: '$45,000', placement: 98 },
      { name: 'Normandale CC Health IT', type: 'Community College', duration: '2 years', cost: '$7,200', placement: 88 }
    ],
    pathways: [
      { level: 'Entry Level', roles: [
        { title: 'Health Information Clerk', salary: '$38K-$48K', requirement: 'HS + Training' },
        { title: 'Patient Access Rep', salary: '$36K-$45K', requirement: 'HS Diploma' },
        { title: 'Insurance Claims Processor', salary: '$40K-$52K', requirement: 'HS + Training' }
      ]},
      { level: 'Technician', roles: [
        { title: 'Health IT Support', salary: '$55K-$70K', requirement: 'Associate Degree' },
        { title: 'Medical Device Technician', salary: '$58K-$72K', requirement: 'Associate + Cert' },
        { title: 'Revenue Cycle Analyst', salary: '$52K-$68K', requirement: 'Associate Degree' }
      ]},
      { level: 'Analyst/Specialist', roles: [
        { title: 'Healthcare Data Analyst', salary: '$70K-$92K', requirement: "Bachelor's + SQL" },
        { title: 'Population Health Analyst', salary: '$75K-$98K', requirement: "Bachelor's + MPH" },
        { title: 'Clinical Application Analyst', salary: '$78K-$100K', requirement: "Bachelor's + Epic Cert" }
      ]},
      { level: 'Engineer/Leadership', roles: [
        { title: 'Health IT Architect', salary: '$120K-$155K', requirement: "Bachelor's + 8yr exp" },
        { title: 'Medical Device Engineer', salary: '$115K-$150K', requirement: "Master's Engineering" },
        { title: 'VP Health Technology', salary: '$175K-$225K', requirement: "MBA + 12yr exp" }
      ]}
    ]
  },
  PA: {
    ...
    technicians: 38000,
    engineers: 28000,
    hubs: ['Philadelphia', 'Pittsburgh', 'Harrisburg'],
    salaries: { engineer: '$125K', technician: '$65K', operator: '$52K' },
    skills: ['Hospital Systems', 'Pharmaceutical Tech', 'Clinical Informatics', 'Healthcare Analytics', 'Telehealth'],
    employers: [
      { name: 'UPMC', positions: 24500, growth: '+14%' },
      { name: 'Penn Medicine', positions: 18200, growth: '+11%' },
      { name: 'Geisinger Health', positions: 8500, growth: '+9%' },
      { name: 'Highmark Health', positions: 6200, growth: '+7%' }
    ],
    training: [
      { name: 'UPenn Health Informatics', type: 'University', duration: '4 years', cost: '$52,000', placement: 96 },
      { name: 'CMU Healthcare AI', type: 'University', duration: '2 years', cost: '$48,000', placement: 97 },
      { name: 'CCAC Health Information Tech', type: 'Community College', duration: '2 years', cost: '$6,800', placement: 87 }
    ],
    pathways: [
      { level: 'Entry Level', roles: [
        { title: 'Health Records Clerk', salary: '$35K-$45K', requirement: 'HS Diploma' },
        { title: 'Medical Billing Specialist', salary: '$38K-$50K', requirement: 'Certification' },
        { title: 'Patient Service Rep', salary: '$34K-$44K', requirement: 'HS Diploma' }
      ]},
      { level: 'Technician', roles: [
        { title: 'HIM Technician', salary: '$50K-$65K', requirement: 'Associate (RHIT)' },
        { title: 'Clinical IT Support', salary: '$52K-$68K', requirement: 'Associate + A+' },
        { title: 'Pharmacy Tech Specialist', salary: '$48K-$62K', requirement: 'CPhT Certification' }
      ]},
      { level: 'Analyst/Specialist', roles: [
        { title: 'Healthcare Business Analyst', salary: '$68K-$88K', requirement: "Bachelor's" },
        { title: 'Clinical Informatics Analyst', salary: '$72K-$95K', requirement: "Bachelor's + Clinical" },
        { title: 'Quality Improvement Specialist', salary: '$70K-$90K', requirement: "Bachelor's + Six Sigma" }
      ]},
      { level: 'Engineer/Leadership', roles: [
        { title: 'Healthcare Systems Engineer', salary: '$110K-$145K', requirement: "Bachelor's + 5yr exp" },
        { title: 'Director Health IT', salary: '$145K-$185K', requirement: "Master's + 10yr exp" },
        { title: 'CMIO', salary: '$250K-$400K', requirement: 'MD + Informatics' }
      ]}
    ]
  },
  NC: {
    ...
    technicians: 29000,
    engineers: 22000,
    hubs: ['Research Triangle', 'Charlotte', 'Winston-Salem'],
    salaries: { engineer: '$118K', technician: '$62K', operator: '$48K' },
    skills: ['Biotech', 'Clinical Trials', 'Medical Research', 'Health IT', 'Genomics'],
    employers: [
      { name: 'Duke Health', positions: 14500, growth: '+12%' },
      { name: 'UNC Health', positions: 11800, growth: '+10%' },
      { name: 'Novant Health', positions: 8200, growth: '+15%' },
      { name: 'LabCorp', positions: 6500, growth: '+8%' }
    ],
    training: [
      { name: 'Duke Health Informatics', type: 'University', duration: '2 years', cost: '$45,000', placement: 96 },
      { name: 'UNC Biomedical Engineering', type: 'University', duration: '4 years', cost: '$32,000', placement: 94 },
      { name: 'Wake Tech Health IT', type: 'Community College', duration: '2 years', cost: '$5,800', placement: 90 }
    ],
    pathways: [
      { level: 'Entry Level', roles: [
        { title: 'Clinical Research Assistant', salary: '$38K-$48K', requirement: "Bachelor's Biology" },
        { title: 'Lab Information Tech', salary: '$40K-$52K', requirement: 'HS + Training' },
        { title: 'Health Data Entry', salary: '$35K-$44K', requirement: 'HS Diploma' }
      ]},
      { level: 'Technician', roles: [
        { title: 'Clinical Lab Tech', salary: '$52K-$68K', requirement: 'MLT Certification' },
        { title: 'Research Technician', salary: '$48K-$62K', requirement: 'Associate + Lab Exp' },
        { title: 'Health IT Technician', salary: '$50K-$65K', requirement: 'Associate Degree' }
      ]},
      { level: 'Analyst/Specialist', roles: [
        { title: 'Bioinformatics Analyst', salary: '$72K-$95K', requirement: "Bachelor's + Coding" },
        { title: 'Clinical Trial Coordinator', salary: '$65K-$85K', requirement: "Bachelor's + CCRC" },
        { title: 'Healthcare Data Scientist', salary: '$85K-$115K', requirement: "Master's + Python/R" }
      ]},
      { level: 'Engineer/Leadership', roles: [
        { title: 'Biomedical Engineer', salary: '$105K-$140K', requirement: "Master's BME" },
        { title: 'Genomics Engineer', salary: '$115K-$155K', requirement: "PhD Genetics" },
        { title: 'Director Clinical Informatics', salary: '$150K-$195K', requirement: "MD/PhD + 8yr exp" }
      ]}
    ]
  },
  FL: {
    ...
    technicians: 52000,
    engineers: 35000,
    hubs: ['Miami', 'Tampa', 'Orlando', 'Jacksonville'],
    salaries: { engineer: '$115K', technician: '$58K', operator: '$46K' },
    skills: ['Geriatric Care Tech', 'Telemedicine', 'Healthcare Admin', 'Medical Tourism', 'Home Health Tech'],
    employers: [
      { name: 'AdventHealth', positions: 18500, growth: '+18%' },
      { name: 'Baptist Health', positions: 12200, growth: '+14%' },
      { name: 'HCA Healthcare FL', positions: 22000, growth: '+12%' },
      { name: 'Cleveland Clinic Florida', positions: 5800, growth: '+25%' }
    ],
    training: [
      { name: 'UF Health Informatics', type: 'University', duration: '4 years', cost: '$28,000', placement: 93 },
      { name: 'USF Health Management', type: 'University', duration: '4 years', cost: '$25,000', placement: 91 },
      { name: 'Miami Dade College Health IT', type: 'Community College', duration: '2 years', cost: '$5,200', placement: 88 }
    ],
    pathways: [
      { level: 'Entry Level', roles: [
        { title: 'Medical Records Tech', salary: '$32K-$42K', requirement: 'HS Diploma' },
        { title: 'Telehealth Coordinator', salary: '$38K-$48K', requirement: 'HS + Training' },
        { title: 'Home Health Tech', salary: '$34K-$44K', requirement: 'CNA Certification' }
      ]},
      { level: 'Technician', roles: [
        { title: 'Health IT Specialist', salary: '$48K-$62K', requirement: 'Associate Degree' },
        { title: 'Medical Office Tech', salary: '$45K-$58K', requirement: 'Associate + Billing' },
        { title: 'Telemedicine Tech', salary: '$50K-$65K', requirement: 'Associate + Cert' }
      ]},
      { level: 'Analyst/Specialist', roles: [
        { title: 'Healthcare Operations Analyst', salary: '$62K-$82K', requirement: "Bachelor's" },
        { title: 'Patient Experience Specialist', salary: '$58K-$75K', requirement: "Bachelor's" },
        { title: 'Population Health Coordinator', salary: '$65K-$85K', requirement: "Bachelor's + MPH" }
      ]},
      { level: 'Engineer/Leadership', roles: [
        { title: 'Healthcare IT Manager', salary: '$95K-$125K', requirement: "Bachelor's + PMP" },
        { title: 'Telehealth Program Director', salary: '$110K-$145K', requirement: "Master's + 7yr exp" },
        { title: 'Chief Nursing Informatics Officer', salary: '$145K-$195K', requirement: 'MSN + Informatics' }
      ]}
    ]
  }
};
...
const highConcentrationStates = ['TX', 'AZ', 'CA', 'OR', 'NY', 'OH', 'ID', 'NM', 'TN', 'MA', 'MN', 'PA', 'NC', 'FL'];
